...
cf cs network-policies default src3 -c '{"type":"source","name":"source3","description":"doe iets leuks src3","scope":"local"}'
cf cs network-policies default dest4 -c '{"type":"destination","source":"source3"}'
cf cs network-policies default src4 -c '{"type":"source","name":"source4","description":"doe iets leuks src4","scope":"local"}'
